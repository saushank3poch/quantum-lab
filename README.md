...
The persistent header has four sections: **Start Simple** opens lesson one, **Practical Example** opens the search comparison, **Deep Dive** opens the detailed lab, and **sources** opens the science notes. These labels do not change with the active mode. The guide visibility control lives with the detailed lab controls.
